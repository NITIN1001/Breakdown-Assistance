...
#d1,#d2{
  ...
  <body>
    ...
    <center>
    <form class="form1" name="form1" action="success.php" method="post" onsubmit="return match()">
<div class="signup">
  ...
  <center><p class="acc">Already have an account?<a href="login.php" class="log"> Login here</a></p></center>
  <script>
  function openNav() {
